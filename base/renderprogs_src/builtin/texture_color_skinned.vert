...
void main()
{
	...
	{
		vofi_TexCoord0.x = dot4( modelPosition, rpTexGen0S );
		vofi_TexCoord0.y = dot4( modelPosition, rpTexGen0T );
	}
	else
	{
		vofi_TexCoord0.x = dot4( in_TexCoord.xy, rpTextureMatrixS );
		vofi_TexCoord0.y = dot4( in_TexCoord.xy, rpTextureMatrixT );
	}
