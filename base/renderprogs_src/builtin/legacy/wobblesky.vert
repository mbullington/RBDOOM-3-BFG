...
void main()
{
	...
	vec3 t0 = position4.xyz - rpLocalViewOrigin.xyz;
	vofi_TexCoord0.x = dot3( t0, rpWobbleSkyX );
	vofi_TexCoord0.y = dot3( t0, rpWobbleSkyY );
	vofi_TexCoord0.z = dot3( t0, rpWobbleSkyZ );
