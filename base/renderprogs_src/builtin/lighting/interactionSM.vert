...
layout( location = 8 ) out vec4 vofi_TexCoord8;
layout( location = 9 ) out vec4 vofi_TexCoord9;
layout( location = 10 ) out vec4 vofi_Color;
...
void main()
{
	...
	vec4 toLightLocal = rpLocalLightOrigin - modelPosition;
	...
	vec4 toLightGlobal = rpGlobalLightOrigin - worldPosition;
