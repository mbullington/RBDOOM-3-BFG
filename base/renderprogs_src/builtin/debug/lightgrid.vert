...
void main()
{
	...
	vofi_TexCoord1.x = dot3( normal, rpModelMatrixX );
	vofi_TexCoord1.y = dot3( normal, rpModelMatrixY );
	vofi_TexCoord1.z = dot3( normal, rpModelMatrixZ );
	vec4 worldPosition;
	...
	vofi_TexCoord0 = worldPosition.xyz;
