...
// RB begin
bool idSWF::Deflate(const byte* input, int inputSize, byte* output,
                    int& outputSize) {
  struct local_swf_alloc_t {
    static void* zalloc(void* opaque, uint32 items, uint32 size) {
      return Mem_Alloc(items * size, TAG_SWF);
