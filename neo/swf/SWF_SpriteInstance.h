...
class idSWFSpriteInstance {
 public:
  ...
  // FIXME: Why do all the Set functions have defaults of -1.0f?  This seems
  // arbitrar. Probably better to not have a default at all, so any
  // non-parametized calls throw a compilation error.
  float GetXPos() const;
  ...
  bool UpdateMoveToScale(
      float speed);  // returns true if the update was successful
  ...
  // Apparently MS's C++ compiler supports the newer C++ standard, and GCC
  // supports C++03 In the new C++ standard, nested members of a friend class
  // have access to private/protected members of the class granting friendship
  // In C++03, nested members defined in a friend class do NOT have access to
  // private/protected members of the class granting friendship	friend class
  // idSWF;
  ...
  // we use 1 based frame numbers because currentFrame = 0 means nothing is in
  // the display list it's also convenient because Flash also uses 1 based frame
  // numbers
  uint16 currentFrame;
  uint16 frameCount;
  ...
  // have access to private/protected members of the class granting friendship
  // In C++03, nested members defined in a friend class do NOT have access to
  // private/protected members of the class granting friendship
...
/*
================================================
This is the prototype object that all the sprite instance script objects
reference
================================================
*/
...
extern idSWFScriptObject_SpriteInstancePrototype
    spriteInstanceScriptObjectPrototype;
