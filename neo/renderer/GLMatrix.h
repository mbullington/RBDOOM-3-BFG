...
This is the old DOOM3 matrix code that should really to be replaced with
idRenderMatrix.
...
// note that these assume a normalized matrix, and will not work with scaled
// axis
