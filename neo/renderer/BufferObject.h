...
class idVertexBuffer : public idBufferObject {
 public:
  ...
  // Copies data to the buffer. 'size' may be less than the originally allocated
  // size.
...
is limited to GL_UNIFORM_BUFFER_OFFSET_ALIGNMENT, which is 256 on current nvidia
cards, so joint offsets, which are multiples of 48 bytes, must be in multiples
of 16 = 768 bytes.
================================================================================================
*/
