...
void idVertexBuffer::Reference(const idVertexBuffer& other) {
  ...
  // assert( other.IsMapped() == false );	// this happens when building
  // idTriangles while at the same time setting up idDrawVerts
...
========================
*/
void idVertexBuffer::Reference(const idVertexBuffer& other, int refOffset,
                               int refSize) {
  assert(IsMapped() == false);
  // assert( other.IsMapped() == false );	// this happens when building
  // idTriangles while at the same time setting up idDrawVerts
...
void idIndexBuffer::Reference(const idIndexBuffer& other) {
  assert(IsMapped() == false);
  // assert( other.IsMapped() == false );	// this happens when building
  // idTriangles while at the same time setting up triIndex_t
  assert(other.GetSize() > 0);
...
========================
*/
void idIndexBuffer::Reference(const idIndexBuffer& other, int refOffset,
                              int refSize) {
  assert(IsMapped() == false);
  // assert( other.IsMapped() == false );	// this happens when building
  // idTriangles while at the same time setting up triIndex_t
...
========================
*/
idUniformBuffer::~idUniformBuffer() { FreeBufferObject(); }
...
========================
*/
void idUniformBuffer::Reference(const idUniformBuffer& other, int refOffset,
                                int refSize) {
  assert(IsMapped() == false);
  assert(other.IsMapped() == false);
  assert(refOffset >= 0);
