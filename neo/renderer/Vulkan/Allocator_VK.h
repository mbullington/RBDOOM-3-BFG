...
class idVulkanBlock {
 ...
 public:
  idVulkanBlock(const uint32 memoryTypeIndex, const VkDeviceSize size,
  ...
  bool Allocate(const uint32 size, const uint32 align,
...
class idVulkanAllocator {
 public:
  ...
  vulkanAllocation_t Allocate(const uint32 size, const uint32 align,
