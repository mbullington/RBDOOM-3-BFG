...
====================
*/
idRenderModelPrt::idRenderModelPrt() { particleSystem = NULL; }
...
idRenderModel* idRenderModelPrt::InstantiateDynamicModel(
    const struct renderEntity_s* renderEntity, const viewDef_t* viewDef,
  ...
  */
  ...
  for (int stageNum = 0; stageNum < particleSystem->stages.Num(); stageNum++) {
    ...
    int stageAge = g.renderView->time[renderEntity->timeGroup] +
...
====================
*/
float idRenderModelPrt::DepthHack() const { return particleSystem->depthHack; }
