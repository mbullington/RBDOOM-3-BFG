...
class idGuiModel {
 public:
  ...
  // the returned pointer will be in write-combined memory, so only make
  // contiguous 32 bit writes and never read from it.
  idDrawVert* AllocTris(int numVerts, const triIndex_t* indexes, int numIndexes,
