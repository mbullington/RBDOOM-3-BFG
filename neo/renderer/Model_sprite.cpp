...
===============
*/
bool idRenderModelSprite::IsLoaded() const { return true; }
...
idRenderModel* idRenderModelSprite::InstantiateDynamicModel(
  ...
  int green =
      idMath::Ftoi(renderEntity->shaderParms[SHADERPARM_GREEN] * 255.0f);
  int blue = idMath::Ftoi(renderEntity->shaderParms[SHADERPARM_BLUE] * 255.0f);
  int alpha =
      idMath::Ftoi(renderEntity->shaderParms[SHADERPARM_ALPHA] * 255.0f);
