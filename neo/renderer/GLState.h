...
static const uint64 GLS_COLORMASK =
    (GLS_REDMASK | GLS_GREENMASK | GLS_BLUEMASK);
...
static const uint64 GLS_CULL_MASK =
    GLS_CULL_FRONTSIDED | GLS_CULL_BACKSIDED | GLS_CULL_TWOSIDED;
...
static const uint64 GLS_STENCIL_FUNC_REF_BITS = 0xFFll
                                                << GLS_STENCIL_FUNC_REF_SHIFT;

static const uint64 GLS_STENCIL_FUNC_MASK_SHIFT = 28;
static const uint64 GLS_STENCIL_FUNC_MASK_BITS = 0xFFll
                                                 << GLS_STENCIL_FUNC_MASK_SHIFT;

#define GLS_STENCIL_MAKE_REF(x) \
  (((uint64)(x) << GLS_STENCIL_FUNC_REF_SHIFT) & GLS_STENCIL_FUNC_REF_BITS)
#define GLS_STENCIL_MAKE_MASK(x) \
  (((uint64)(x) << GLS_STENCIL_FUNC_MASK_SHIFT) & GLS_STENCIL_FUNC_MASK_BITS)

// Next 12 bits act as front+back unless GLS_SEPARATE_STENCIL is set, in which
// case it acts as front.
...
// Next 12 bits act as back and are only active when GLS_SEPARATE_STENCIL is
// set.
...
static const uint64 GLS_SEPARATE_STENCIL = GLS_BACK_STENCIL_OP_FAIL_BITS |
                                           GLS_BACK_STENCIL_OP_ZFAIL_BITS |
                                           GLS_BACK_STENCIL_OP_PASS_BITS;
static const uint64 GLS_STENCIL_OP_BITS =
    GLS_STENCIL_OP_FAIL_BITS | GLS_STENCIL_OP_ZFAIL_BITS |
    GLS_STENCIL_OP_PASS_BITS | GLS_SEPARATE_STENCIL;
static const uint64 GLS_STENCIL_FRONT_OPS = GLS_STENCIL_OP_FAIL_BITS |
                                            GLS_STENCIL_OP_ZFAIL_BITS |
...
static const uint64 GLS_OVERRIDE = 1ull
                                   << 63;  // override the render prog state
