...
======================
*/
void BSEntity::SetVisible(bool isVisible) { visible = isVisible; }
...
=============================
*/
bool idGameBearShootWindow::ParseInternalVar(const char* _name,
                                             idTokenParser* src) {
...
=============================
*/
void idGameBearShootWindow::PostParse() { idWindow::PostParse(); }
...
=============================
*/
const char* idGameBearShootWindow::Activate(bool activate) { return ""; }
