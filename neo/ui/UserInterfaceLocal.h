...
class idUserInterfaceLocal : public idUserInterface {
 ...
 public:
  ...
  virtual bool InitFromFile(const char* qpath, bool rebuild = true,
                            bool cache = true);
  virtual const char* HandleEvent(const sysEvent_t* event, int time,
                                  bool* updateVisuals);
...
class idUserInterfaceManagerLocal : public idUserInterfaceManager {
 ...
 public:
  ...
  virtual idUserInterface* FindGui(const char* qpath, bool autoLoad = false,
