...
======================
*/
void BOEntity::SetVisible(bool isVisible) { visible = isVisible; }
...
BOBrick::BOBrick(BOEntity* _ent, float _x, float _y, float _width,
                 float _height) {
  ent = _ent;
  x = _x;
  y = _y;
...
=============================
*/
bool idGameBustOutWindow::ParseInternalVar(const char* _name,
                                           idTokenParser* src) {
...
=============================
*/
void idGameBustOutWindow::PostParse() { idWindow::PostParse(); }
...
=============================
*/
const char* idGameBustOutWindow::Activate(bool activate) { return ""; }
