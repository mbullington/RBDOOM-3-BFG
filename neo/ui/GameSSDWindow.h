...
class SSDAsteroid : public SSDMover {
 ...
 public:
  ...
  void Init(idGameSSDWindow* _game, const idVec3& startPosition,
            const idVec2& _size, float _speed, float rotate, int _health);
...
class SSDAstronaut : public SSDMover {
 ...
 public:
  ...
  void Init(idGameSSDWindow* _game, const idVec3& startPosition, float _speed,
            float rotate, int _health);
...
class SSDExplosion : public SSDEntity {
 ...
 public:
  ...
  void Init(idGameSSDWindow* _game, const idVec3& _position,
            const idVec2& _size, int _length, int _type, SSDEntity* _buddy,
            bool _killBuddy = true, bool _followBuddy = true);
...
class SSDPoints : public SSDEntity {
 ...
 public:
  ...
  void Init(idGameSSDWindow* _game, SSDEntity* _ent, int _points, int _length,
            int _distance, const idVec4& color);
  virtual void EntityUpdate();

  static SSDPoints* GetNewPoints(idGameSSDWindow* _game, SSDEntity* _ent,
...
class SSDProjectile : public SSDEntity {
 ...
 public:
  ...
  void Init(idGameSSDWindow* _game, const idVec3& _beginPosition,
            const idVec3& _endPosition, float _speed, float _size);
  virtual void EntityUpdate();
...
class SSDPowerup : public SSDMover {
 ...
 public:
  ...
  static SSDPowerup* GetNewPowerup(idGameSSDWindow* _game, float _speed,
                                   float _rotation);
