...
void idListWindow::AddCurrentSel(int sel) { currentSel.Append(sel); }
...
idWinVar* idListWindow::GetWinVarByName(const char* _name, bool fixup,
                                        drawWin_t** owner) {
...
void idListWindow::StateChanged(bool redraw) { UpdateList(); }
