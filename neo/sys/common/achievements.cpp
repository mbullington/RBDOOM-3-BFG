...
========================
*/
bool idAchievementSystemWin::IsInitialized() { return false; }
...
================================
*/
void idAchievementSystemWin::AchievementUnlock(idLocalUser* user,
                                               int achievementID) {}
...
========================
*/
void idAchievementSystemWin::AchievementLock(idLocalUser* user,
...
========================
*/
void idAchievementSystemWin::AchievementLockAll(idLocalUser* user,
                                                const int maxId) {}
...
bool idAchievementSystemWin::GetAchievementDescription(
    idLocalUser* user, const int achievementID,
...
========================
*/
bool idAchievementSystemWin::GetAchievementState(
    idLocalUser* user,
