...
// system should map this to KP_COMMA or something,
//                                         according to USB doc, so probably it
//                                         doesn't need mapping here)

// maps SDL2 scancodes to directinput keynums/scancodes - dinput_key =
// scanCodeToKeyNum[(int)your_sdl2_scancode];
static int scanCodeToKeyNum[SDL_NUM_SCANCODES] = {
    0x0,   //	SDL_SCANCODE_UNKNOWN = 0, => 0 should also work for dinput codes
    ...
    0x2B,  //	SDL_SCANCODE_BACKSLASH = 49, // next to enter, US: [\|] DE: [#']
           //UK: [#~] - DIK_BACKSLASH
    0x2B,  //	SDL_SCANCODE_NONUSHASH = 50, // same key as before actually on
           //some layouts, systems should map this to SDL_SCANCODE_BACKSLASH -
           //DIK_BACKSLASH
    0x27,  //	SDL_SCANCODE_SEMICOLON = 51, - DIK_SEMICOLON
    0x28,  //	SDL_SCANCODE_APOSTROPHE = 52, - DIK_APOSTROPHE
    0x29,  //	SDL_SCANCODE_GRAVE = 53, // "quake/doom3 console key" -
           //DIK_GRAVE
    ...
    0xB7,  //	SDL_SCANCODE_PRINTSCREEN = 70, // - DIK_SYSRQ;
           //SDL_SCANCODE_SYSREQ also maps to this!

    0x46,  //	SDL_SCANCODE_SCROLLLOCK = 71, - DIK_SCROLL
    0xC5,  //	SDL_SCANCODE_PAUSE = 72, - DIK_PAUSE
    0xD2,  //	SDL_SCANCODE_INSERT = 73, // insert on PC, help on some Mac
           //keyboards (but does send code 73, not 117) - DIK_INSERT
    ...
    0x45,  //	SDL_SCANCODE_NUMLOCKCLEAR = 83, // num lock on PC, clear on Mac
           //keyboards - DIK_NUMLOCK
    ...
    0x56,  //	SDL_SCANCODE_NONUSBACKSLASH = 100, // [<>|] on german keyboard,
           //next to left shift - DIK_OEM_102
    0xDD,  //	SDL_SCANCODE_APPLICATION = 101, // windows contextual menu,
           //compose - DIK_APPS
    0xDE,  //	SDL_SCANCODE_POWER = 102, // should be a status flag, but some
           //mac keyboards have a power key - DIK_POWER
    ...
    0x67,  //	SDL_SCANCODE_F16 = 107, // TODO: F16 and up don't have DIK_
           //constants! is this right?
    0x68,  //	SDL_SCANCODE_F17 = 108, //        (at least 0x67-0x6F have no
           //DIK_constants at all)
    ...
    0x73,  //	SDL_SCANCODE_INTERNATIONAL1 = 135, // this is really brazilian /
           //and ? - DIK_ABNT_C1
    0x0,   //	SDL_SCANCODE_INTERNATIONAL2 = 136, // TODO: Hut1_12v2.pdf page
           //60, footnote 16
    0x7D,  //	SDL_SCANCODE_INTERNATIONAL3 = 137, - DIK_YEN
    0x79,  //	SDL_SCANCODE_INTERNATIONAL4 = 138, // Japan: XFER/"convert kana
           //-> kanji", right of space - DIK_CONVERT
    0x7B,  //	SDL_SCANCODE_INTERNATIONAL5 = 139, // Japan: NFER/"don't convert
           //kana -> kanji", left of space - DIK_NOCONVERT
    0x0,   //	SDL_SCANCODE_INTERNATIONAL6 = 140, // TODO: Hut1_12v2.pdf page
           //60, footnote 20
    0x0,   //	SDL_SCANCODE_INTERNATIONAL7 = 141, // Toggle
           //Double-Byte/Single-Byte mode.
    0x0,   //	SDL_SCANCODE_INTERNATIONAL8 = 142, // Undefined, available for
           //other Front End Language Processors
    0x0,   //	SDL_SCANCODE_INTERNATIONAL9 = 143, // Undefined, available for
           //other Front End Language Processors
    ...
    0xB7,  //	SDL_SCANCODE_SYSREQ = 154, - DIK_SYSRQ; SDL_SCANCODE_PRINTSCREEN
           //also maps to this!
    ...
    0xDB,  //	SDL_SCANCODE_LGUI = 227, // left windows, command (apple), meta
           //- DIK_LWIN
    0x9D,  //	SDL_SCANCODE_RCTRL = 228, - DIK_RCONTROL
    0x36,  //	SDL_SCANCODE_RSHIFT = 229, - DIK_RSHIFT
    0xB8,  //	SDL_SCANCODE_RALT = 230, // right Alt/AltGr, option - DIK_RMENU,
           //also used for SDL_SCANCODE_MODE!
    0xDC,  //	SDL_SCANCODE_RGUI = 231, // left windows, command (apple), meta
           //- DIK_RWIN
    ...
    0xB8,  //	SDL_SCANCODE_MODE = 257,  // this seems to be the AltGr Key? -
           //DIK_RMENU (right alt)

    // These values are mapped from usage page 0x0C (USB consumer page).
    0x99,  //	SDL_SCANCODE_AUDIONEXT = 258, - DIK_NEXTTRACK
    0x90,  //	SDL_SCANCODE_AUDIOPREV = 259, - DIK_PREVTRACK, which is
           //DIK_CIRCUMFLEX on japanese keyboards
    ...
    0x0,  //	SDL_SCANCODE_DISPLAYSWITCH = 277, // display mirroring/dual
