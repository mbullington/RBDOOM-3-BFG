...
#pragma warning(disable : 4740)  // warning C4740: flow in or out of inline asm
                                 // code suppresses global optimization
#pragma warning( \
    disable : 4731)  // warning C4731: 'XXX' : frame pointer register 'ebx'
...
static const char* roundingControlField[] = {"Round to nearest", "Round down",
...
===============
*/
int Sys_FPU_PrintStateFlags(char* ptr, int ctrl, int stat, int tags, int inof,
                            int inse, int opof, int opse) {
  int i, length = 0;
...
===============
*/
const char* Sys_FPU_GetState() { return "TODO Sys_FPU_GetState()"; }
