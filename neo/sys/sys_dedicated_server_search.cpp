...
========================
*/
idDedicatedServerSearch::idDedicatedServerSearch() : callback(NULL) {}
...
========================
*/
void idDedicatedServerSearch::HandleQueryAck(lobbyAddress_t& addr,
                                             idBitMsg& msg) {
  bool found = false;
...
========================
*/
const serverInfo_t* idDedicatedServerSearch::DescribeServerAtIndex(
    int i) const {
  if (i >= 0 && i < list.Num()) {
...
========================
*/
const idList<idStr>* idDedicatedServerSearch::GetServerPlayersAtIndex(
    int i) const {
  if (i >= 0 && i < list.Num()) {
...
========================
*/
int idDedicatedServerSearch::NumServers() const { return list.Num(); }