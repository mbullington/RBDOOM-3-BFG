...
================
*/
void CM_RotatePoint(idVec3& point, const idVec3& origin, const idVec3& axis,
...
================
*/
void CM_RotateEdge(idVec3& start, idVec3& end, const idVec3& origin,
                   const idVec3& axis, const float tanHalfAngle) {
  double d, t, s, c;
  idVec3 proj, v1, v2;
...
int idCollisionModelManagerLocal::CollisionBetweenEdgeBounds(
    cm_traceWork_t* tw, const idVec3& va, const idVec3& vb, const idVec3& vc,
    const idVec3& vd, float tanHalfAngle, idVec3& collisionPoint,
...
================
*/
int idCollisionModelManagerLocal::RotateEdgeThroughEdge(
    cm_traceWork_t* tw, const idPluecker& pl1, const idVec3& vc,
    const idVec3& vd, const float minTan, float& tanHalfAngle) {
...
================
*/
int idCollisionModelManagerLocal::EdgeFurthestFromEdge(
    cm_traceWork_t* tw, const idPluecker& pl1, const idVec3& vc,
    const idVec3& vd, float& tanHalfAngle, float& dir) {
  double v0, v1, v2, a, b, c, d, sqrtd, q, frac1, frac2;
  idVec3 ct, dt;
  idPluecker pl2;
...
void idCollisionModelManagerLocal::RotateTrmEdgeThroughPolygon(
    cm_traceWork_t* tw, cm_polygon_t* poly, cm_trmEdge_t* trmEdge) {
  int i, j, edgeNum;
...
int idCollisionModelManagerLocal::RotatePointThroughPlane(
    const cm_traceWork_t* tw, const idVec3& point, const idPlane& plane,
...
int idCollisionModelManagerLocal::RotatePointThroughEpsilonPlane(
    const cm_traceWork_t* tw, const idVec3& point, const idVec3& endPoint,
...
void idCollisionModelManagerLocal::RotateTrmVertexThroughPolygon(
    cm_traceWork_t* tw, cm_polygon_t* poly, cm_trmVertex_t* v, int vertexNum) {
  int i;
  float tanHalfAngle;
...
void idCollisionModelManagerLocal::RotateVertexThroughTrmPolygon(
    cm_traceWork_t* tw, cm_trmPolygon_t* trmpoly, cm_polygon_t* poly,
...
================
*/
void idCollisionModelManagerLocal::Rotation180(
    trace_t* results, const idVec3& rorg, const idVec3& axis,
  ...
  tw.axis = axis;
  //	assert( tw.axis[0] * tw.axis[0] + tw.axis[1] * tw.axis[1] + tw.axis[2] *
  //tw.axis[2] > 0.99f );
...
void idCollisionModelManagerLocal::Rotation(
    trace_t* results, const idVec3& start, const idRotation& rotation,
    const idTraceModel* trm, const idMat3& trmAxis, int contentMask,
    cmHandle_t model, const idVec3& modelOrigin, const idMat3& modelAxis) {
  idVec3 tmp;
