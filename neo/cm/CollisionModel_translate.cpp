...
================
*/
float CM_TranslationPlaneFraction(const idPlane& plane, const idVec3& start,
                                  const idVec3& end) {
...
void idCollisionModelManagerLocal::TranslateTrmVertexThroughPolygon(
    cm_traceWork_t* tw, cm_polygon_t* poly, cm_trmVertex_t* v, int bitNum) {
  int i, edgeNum;
  float f;
  cm_edge_t* edge;
...
void idCollisionModelManagerLocal::TranslatePointThroughPolygon(
    cm_traceWork_t* tw, cm_polygon_t* poly, cm_trmVertex_t* v) {
  int i, edgeNum;
  float f;
  cm_edge_t* edge;
  idPluecker pl;
...
void idCollisionModelManagerLocal::TranslateVertexThroughTrmPolygon(
    ...
    cm_vertex_t* v, idVec3& endp, idPluecker& pl) {
  int i, edgeNum;
  float f;
  cm_trmEdge_t* edge;
...
bool idCollisionModelManagerLocal::TranslateTrmThroughPolygon(
    cm_traceWork_t* tw, cm_polygon_t* p) {
  int i, j, k, edgeNum;
  float fraction, d;
  idVec3 endp;
  idPluecker* pl;
...
void idCollisionModelManagerLocal::Translation(
    trace_t* results, const idVec3& start, const idVec3& end,
