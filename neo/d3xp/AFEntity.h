...
class idChain : public idMultiModelAF {
 ...
 protected:
  void BuildChain(const idStr& name, const idVec3& origin, float linkLength,
                  float linkWidth, float density, int numLinks,
...
class idAFAttachment : public idAnimatedEntity {
 public:
  ...
  void SetBody(idEntity* bodyEnt, const char* headModel,
