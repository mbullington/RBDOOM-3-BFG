...
================
*/
bool idIK::IsInitialized() const { return initialized && ik_enable.GetBool(); }
...
================
*/
void idIK::ClearJointMods() { ik_activate = false; }
...
================
*/
bool idIK::SolveTwoBones(const idVec3& startPos, const idVec3& endPos,
                         const idVec3& dir, float len0, float len1,
                         idVec3& jointPos) {
...
================
*/
float idIK::GetBoneAxis(const idVec3& startPos, const idVec3& endPos,
                        const idVec3& dir, idMat3& axis) {
  float length;
...
================
*/
bool idIK_Walk::Init(idEntity* self, const char* anim,
...
================
*/
void idIK_Walk::EnableLeg(int num) { enabledLegs |= 1 << num; }
...
================
*/
void idIK_Walk::DisableLeg(int num) { enabledLegs &= ~(1 << num); }
...
================
*/
bool idIK_Reach::Init(idEntity* self, const char* anim,
                      const idVec3& modelOffset) {
  int i;
  const char* jointName;
  idTraceModel trm;
