...
================
*/
idSaveGame::idSaveGame(idFile* savefile, idFile* stringTableFile,
                       int saveVersion) {
...
void idSaveGame::Close() {
  ...
  if (file->Length() > MIN_SAVEGAME_SIZE_BYTES ||
      stringFile->Length() > MAX_SAVEGAME_STRING_TABLE_SIZE) {
...
================
*/
void idSaveGame::AddObject(const idClass* obj) { objects.AddUnique(obj); }
...
================
*/
void idSaveGame::WriteInt(const int value) { file->WriteBig(value); }
...
================
*/
void idSaveGame::WriteShort(const short value) { file->WriteBig(value); }
...
================
*/
void idSaveGame::WriteFloat(const float value) { file->WriteBig(value); }
...
================
*/
void idSaveGame::WriteBool(const bool value) { file->WriteBool(value); }
...
void idSaveGame::WriteString(const char* string) {
  ...
  // If we already have this string in our hash, write out of the offset in the
  // table and return
  ...
  // Add the string to our hash, generate the index, and update our current
  // table offset
...
================
*/
void idSaveGame::WriteVec2(const idVec2& vec) { file->WriteBig(vec); }
...
================
*/
void idSaveGame::WriteVec3(const idVec3& vec) { file->WriteBig(vec); }
...
================
*/
void idSaveGame::WriteVec4(const idVec4& vec) { file->WriteBig(vec); }
...
================
*/
void idSaveGame::WriteVec6(const idVec6& vec) { file->WriteBig(vec); }
...
================
*/
void idSaveGame::WriteBounds(const idBounds& bounds) { file->WriteBig(bounds); }
...
================
*/
void idSaveGame::WriteMat3(const idMat3& mat) { file->WriteBig(mat); }
...
================
*/
void idSaveGame::WriteAngles(const idAngles& angles) { file->WriteBig(angles); }
...
// RB begin
void idSaveGame::WriteRenderEnvprobe(
    const renderEnvironmentProbe_t& renderEnvprobe) {
...
===================
*/
void idSaveGame::WriteSoundCommands() { gameSoundWorld->WriteToSaveGame(file); }
...
================
*/
idRestoreGame::idRestoreGame(idFile* savefile, idFile* stringTableFile,
                             int saveVersion) {
  file = savefile;
  stringFile = stringTableFile;
  version = saveVersion;
...
================
*/
void idRestoreGame::Read(void* buffer, int len) { file->Read(buffer, len); }
...
================
*/
void idRestoreGame::ReadInt(int& value) { file->ReadBig(value); }
...
================
*/
void idRestoreGame::ReadShort(short& value) { file->ReadBig(value); }
...
================
*/
void idRestoreGame::ReadByte(byte& value) { file->Read(&value, sizeof(value)); }
...
================
*/
void idRestoreGame::ReadFloat(float& value) { file->ReadBig(value); }
...
================
*/
void idRestoreGame::ReadBool(bool& value) { file->ReadBig(value); }
...
================
*/
void idRestoreGame::ReadVec2(idVec2& vec) { file->ReadBig(vec); }
...
================
*/
void idRestoreGame::ReadVec3(idVec3& vec) { file->ReadBig(vec); }
...
================
*/
void idRestoreGame::ReadVec4(idVec4& vec) { file->ReadBig(vec); }
...
================
*/
void idRestoreGame::ReadVec6(idVec6& vec) { file->ReadBig(vec); }
...
================
*/
void idRestoreGame::ReadBounds(idBounds& bounds) { file->ReadBig(bounds); }
...
================
*/
void idRestoreGame::ReadMat3(idMat3& mat) { file->ReadBig(mat); }
...
================
*/
void idRestoreGame::ReadAngles(idAngles& angles) { file->ReadBig(angles); }
...
// RB begin
void idRestoreGame::ReadRenderEnvprobe(
    renderEnvironmentProbe_t& renderEnvprobe) {
