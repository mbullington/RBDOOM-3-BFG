...
void idEntityFx::ApplyFade(const idFXSingleAction& fxaction,
                           idFXLocalAction& laction, const int time,
        ...
        if (!useAction->shakeStarted) {
          ...
          for (j = 0; j < gameLocal.numClients; j++) {
            ...
            if (player &&
              ...
              if (!common->IsMultiplayer() || !fxaction.shakeIgnoreMaster ||
...
================
*/
idEntityFx* idEntityFx::StartFx(const char* fx, const idVec3* useOrigin,
                                const idMat3* useAxis, idEntity* ent,
                                bool bind) {
...
=================
*/
void idEntityFx::ClientThink(const int curTime, const float fraction,
                             const bool predict) {
