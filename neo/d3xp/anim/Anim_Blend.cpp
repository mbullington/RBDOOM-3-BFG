...
idAnim::idAnim(const idDeclModelDef* modelDef, const idAnim* anim) {
  ...
  for (i = 0; i < frameCommands.Num(); i++) {
    ...
    if (anim->frameCommands[i].string) {
      frameCommands[i].string =
          new (TAG_ANIM) idStr(*anim->frameCommands[i].string);
    }
  }
}
...
=====================
*/
void idAnim::SetAnim(const idDeclModelDef* modelDef, const char* sourcename,
                     const char* animname, int num,
...
=====================
*/
const char* idAnim::Name() const { return name; }
...
=====================
*/
const char* idAnim::FullName() const { return realname; }
...
=====================
*/
const idDeclModelDef* idAnim::ModelDef() const { return modelDef; }
...
=====================
*/
int idAnim::NumAnims() const { return numAnims; }
...
=====================
*/
bool idAnim::GetOrigin(idVec3& offset, int animNum, int currentTime,
...
=====================
*/
bool idAnim::GetOriginRotation(idQuat& rotation, int animNum, int currentTime,
                               int cyclecount) const {
  if (!anims[animNum]) {
...
=====================
*/
void idAnim::SetAnimFlags(const animFlags_t& animflags) { flags = animflags; }
...
=====================
*/
const animFlags_t& idAnim::GetAnimFlags() const { return flags; }
...
=====================
*/
idAnimBlend::idAnimBlend() { Reset(NULL); }
...
=====================
*/
float idAnimBlend::GetFinalWeight() const { return blendEndValue; }
...
=====================
*/
int idAnimBlend::GetCycleCount() const { return cycle; }
...
=====================
*/
float idAnimBlend::GetPlaybackRate() const { return rate; }
...
=====================
*/
void idAnimBlend::AllowMovement(bool allow) { allowMove = allow; }
...
=====================
*/
void idAnimBlend::AllowFrameCommands(bool allow) { allowFrameCommands = allow; }
...
=====================
*/
int idAnimBlend::AnimNum() const { return animNum; }
...
=====================
*/
void idAnimBlend::CallFrameCommands(idEntity* ent, int fromtime,
                                    int totime) const {
  const idMD5Anim* md5anim;
  frameBlend_t frame1;
  frameBlend_t frame2;
...
bool idAnimBlend::BlendAnim(int currentTime, int channel, int numJoints,
                            ...
                            bool removeOriginOffset, bool overrideBlend,
...
=====================
*/
void idAnimBlend::BlendOrigin(int currentTime, idVec3& blendPos,
                              float& blendWeight,
...
=====================
*/
void idAnimBlend::BlendDelta(int fromtime, int totime, idVec3& blendDelta,
...
=====================
*/
void idAnimBlend::BlendDeltaRotation(int fromtime, int totime,
                                     idQuat& blendDelta,
                                     float& blendWeight) const {
  idQuat q1;
  idQuat q2;
...
=====================
*/
bool idAnimBlend::AddBounds(int currentTime, idBounds& bounds,
                            bool removeOriginOffset) const {
  int i;
  int num;
  idBounds b;
...
=================
*/
size_t idDeclModelDef::Size() const { return sizeof(idDeclModelDef); }
...
================
*/
const char* idDeclModelDef::DefaultDefinition() const { return "{ }"; }
...
=====================
*/
const idDeclSkin* idDeclModelDef::GetDefaultSkin() const { return skin; }
...
=====================
*/
void idDeclModelDef::SetupJoints(int* numJoints, idJointMat** jointList,
...
=====================
*/
int idDeclModelDef::NumAnims() const { return anims.Num() + 1; }
...
=====================
*/
const idDeclSkin* idDeclModelDef::GetSkin() const { return skin; }
...
=====================
*/
const idList<jointInfo_t>& idDeclModelDef::Joints() const { return joints; }
...
=====================
*/
const int* idDeclModelDef::JointParents() const { return jointParents.Ptr(); }
...
=====================
*/
int idDeclModelDef::NumJoints() const { return joints.Num(); }
...
=====================
*/
const idVec3& idDeclModelDef::GetVisualOffset() const { return offset; }
...
=====================
*/
size_t idAnimator::Size() const { return sizeof(*this) + Allocated(); }
...
=====================
*/
bool idAnimator::RemoveOrigin() const { return removeOriginOffset; }
...
=====================
*/
int idAnimator::NumJoints() const { return numJoints; }
...
=====================
*/
void idAnimator::SetFrame(int channelNum, int animNum, int frame,
                          int currentTime, int blendTime) {
  if ((channelNum < 0) || (channelNum >= ANIM_NumAnimChannels)) {
...
=====================
*/
void idAnimator::CycleAnim(int channelNum, int animNum, int currentTime,
                           int blendTime) {
  if ((channelNum < 0) || (channelNum >= ANIM_NumAnimChannels)) {
...
=====================
*/
void idAnimator::PlayAnim(int channelNum, int animNum, int currentTime,
                          int blendTime) {
  if ((channelNum < 0) || (channelNum >= ANIM_NumAnimChannels)) {
...
=====================
*/
void idAnimator::SyncAnimChannels(int channelNum, int fromChannelNum,
                                  int currentTime, int blendTime) {
  if ((channelNum < 0) || (channelNum >= ANIM_NumAnimChannels) ||
...
====================
*/
bool idAnimator::GetDeltaRotation(int fromtime, int totime,
                                  idMat3& delta) const {
  int i;
  const idAnimBlend* blend;
  float blendWeight;
...
void idAnimator::SetAFPoseJointMod(const jointHandle_t jointNum,
                                   ...
                                   const idMat3& axis, const idVec3& origin) {
...
=====================
*/
void idAnimator::FinishAFPose(int animNum, const idBounds& bounds,
                              const int time) {
  int i, j;
  int numJoints;
  int parentNum;
...
=====================
*/
void idAnimator::ClearForceUpdate() { forceUpdate = false; }
...
=====================
*/
bool idAnimator::GetJointTransform(jointHandle_t jointHandle, int currentTime,
...
void idGameEdit::ANIM_CreateAnimFrame(const idRenderModel* model,
                                      const idMD5Anim* anim, int numJoints,
                                      idJointMat* joints, int time,
                                      const idVec3& offset,
