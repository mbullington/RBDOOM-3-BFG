...
class EnvironmentProbe : public idEntity {
 public:
  ...
  //	virtual bool	ClientReceiveEvent( int event, int time, const idBitMsg&
  //msg );

 private:
  renderEnvironmentProbe_t
      renderEnvprobe;           // envprobe presented to the renderer
 ...
 private:
  ...
  void Event_SetEnvprobeParms(float parm0, float parm1, float parm2,
                              float parm3);
