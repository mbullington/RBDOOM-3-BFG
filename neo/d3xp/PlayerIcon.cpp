...
static const char* iconKeys[ICON_NONE] = {
    "mtr_icon_lag", "mtr_icon_chat", "mtr_icon_redteam", "mtr_icon_blueteam"};
...
===============
*/
idPlayerIcon::~idPlayerIcon() { FreeIcon(); }
...
===============
*/
bool idPlayerIcon::CreateIcon(idPlayer* player, playerIconType_t type,
...
*/
bool idPlayerIcon::CreateIcon(idPlayer* player, playerIconType_t type,
                              const char* mtr, const idVec3& origin,
                              const idMat3& axis) {
  assert(type != ICON_NONE);
...
===============
*/
void idPlayerIcon::UpdateIcon(idPlayer* player, const idVec3& origin,
                              const idMat3& axis) {
  assert(iconHandle >= 0);
