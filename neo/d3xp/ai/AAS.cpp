...
============
*/
idAAS* idAAS::Alloc() { return new (TAG_AAS) idAASLocal; }
...
============
*/
idAASLocal::idAASLocal() { file = NULL; }
...
============
*/
idAASLocal::~idAASLocal() { Shutdown(); }
...
============
*/
bool idAASLocal::Trace(aasTrace_t& trace, const idVec3& start,
