...
============
*/
bool idAASLocal::EdgeSplitPoint(idVec3& split, int edgeNum,
...
============
*/
bool idAASLocal::FloorEdgeSplitPoint(idVec3& bestSplit, int areaNum,
...
============
*/
bool idAASLocal::WalkPathValid(int areaNum, const idVec3& origin,
                               int goalAreaNum, const idVec3& goalOrigin,
                               int travelFlags, idVec3& endPos,
...
============
*/
idVec3 idAASLocal::SubSampleWalkPath(int areaNum, const idVec3& origin,
...
============
*/
bool idAASLocal::WalkPathToGoal(aasPath_t& path, int areaNum,
...
============
*/
bool idAASLocal::FlyPathValid(int areaNum, const idVec3& origin,
                              int goalAreaNum, const idVec3& goalOrigin,
                              int travelFlags, idVec3& endPos,
                              int& endAreaNum) const {
  aasTrace_t trace;
...
============
*/
idVec3 idAASLocal::SubSampleFlyPath(int areaNum, const idVec3& origin,
                                    const idVec3& start, const idVec3& end,
                                    int travelFlags, int& endAreaNum) const {
  int i, numSamples, curAreaNum;
  idVec3 dir, point, nextPoint, endPos;
...
============
*/
bool idAASLocal::FlyPathToGoal(aasPath_t& path, int areaNum,
                               const idVec3& origin, int goalAreaNum,
                               const idVec3& goalOrigin,
                               int travelFlags) const {
  int i, travelTime, curAreaNum, lastAreas[4], lastAreaIndex, endAreaNum;
...
============
*/
int idAASLocal::GetWallEdges(int areaNum, const idBounds& bounds,
                             int travelFlags, int* edges, int maxEdges) const {
