...
const idEventDef AI_ClosestReachableEnemyOfEntity(
    "closestReachableEnemyOfEntity", "E", 'e');
...
const idEventDef AI_TestAnimMoveTowardEnemy("testAnimMoveTowardEnemy", "s",
                                            'd');
...
const idEventDef AI_TravelDistanceBetweenEntities(
    "travelDistanceBetweenEntities", "ee", 'f');
...
void idAI::Event_HeardSound(int ignore_team) {
  ...
  if (actor != NULL &&
      (!ignore_team || (ReactionTo(actor) & ATTACK_ON_SIGHT)) &&
...
=====================
*/
void idAI::Event_ClearEnemy() { ClearEnemy(); }
...
=====================
*/
void idAI::Event_BeginAttack(const char* name) { BeginAttack(name); }
...
=====================
*/
void idAI::Event_EndAttack() { EndAttack(); }
...
=====================
*/
void idAI::Event_GetHealth() { idThread::ReturnFloat(health); }
...
=====================
*/
void idAI::Event_AllowDamage() { fl.takedamage = true; }
...
=====================
*/
void idAI::Event_IgnoreDamage() { fl.takedamage = false; }
...
=====================
*/
void idAI::Event_GetCurrentYaw() { idThread::ReturnFloat(current_yaw); }
...
=====================
*/
void idAI::Event_TurnTo(float angle) { TurnToward(angle); }
...
=====================
*/
void idAI::Event_TurnToPos(const idVec3& pos) { TurnToward(pos); }
...
=====================
*/
void idAI::Event_MoveStatus() { idThread::ReturnInt(move.moveStatus); }
...
=====================
*/
void idAI::Event_StopMove() { StopMove(MOVE_STATUS_DONE); }
...
=====================
*/
void idAI::Event_Wander() { WanderAround(); }
...
=====================
*/
void idAI::Event_FaceEnemy() { FaceEnemy(); }
...
=====================
*/
void idAI::Event_GetJumpVelocity(const idVec3& pos, float speed,
                                 float max_height) {
  idVec3 start;
  idVec3 end;
  idVec3 dir;
...
=====================
*/
void idAI::Event_GetEnemy() { idThread::ReturnEntity(enemy.GetEntity()); }
...
=====================
*/
void idAI::Event_GetEnemyPos() { idThread::ReturnVector(lastVisibleEnemyPos); }
...
void idAI::Event_TestAnimMoveTowardEnemy(const char* animname) {
  ...
  if (ai_debugMove.GetBool()) {
    gameRenderWorld->DebugLine(colorGreen, physicsObj.GetOrigin(),
                               physicsObj.GetOrigin() + moveVec, 1);
    gameRenderWorld->DebugBounds(path.endEvent == 0 ? colorYellow : colorRed,
...
=====================
*/
void idAI::Event_NumSmokeEmitters() { idThread::ReturnInt(particles.Num()); }
...
=====================
*/
void idAI::Event_GetMoveType() { idThread::ReturnInt(move.moveType); }
...
=====================
*/
void idAI::Event_SaveMove() { savedMove = move; }
...
=====================
*/
void idAI::Event_AllowMovement(float flag) { allowMove = (flag != 0.0f); }
...
=====================
*/
void idAI::Event_JumpFrame() { AI_JUMP = true; }
...
=====================
*/
void idAI::Event_EnableGravity() { disableGravity = false; }
...
=====================
*/
void idAI::Event_DisableGravity() { disableGravity = true; }
...
=====================
*/
void idAI::Event_EnableAFPush() { af_push_moveables = true; }
...
=====================
*/
void idAI::Event_DisableAFPush() { af_push_moveables = false; }
...
================
*/
void idAI::Event_SetFlyOffset(int offset) { fly_offset = offset; }
...
===============
*/
void idAI::Event_SetJointMod(int allow) { allowJointMod = (allow != 0); }
...
void idAI::Event_GetTrajectoryToPlayer() {
  ...
  //	result = PredictTrajectory( start, end, speed, physicsObj.GetGravity(),
  //physicsObj.GetClipModel(), MASK_MONSTERSOLID, 1000.0f, this, enemyEnt,
  //ai_debugMove.GetBool() ? 4000 : 0, dir ); 	if ( result ) {
  idThread::ReturnVector(dir * speed);
  // 	} else {
  // 		idThread::ReturnVector( vec3_zero );
  // 	}
...
================
*/
void idAI::Event_Kill() { PostEventMS(&AI_RealKill, 0); }
...
================
*/
void idAI::Event_GetTurnRate() { idThread::ReturnFloat(turnRate); }
...
================
*/
void idAI::Event_SetTurnRate(float rate) { turnRate = rate; }
...
void idAI::Event_StartEmitter(const char* name, const char* joint,
                              const char* particle) {
...
void idAI::Event_StopEmitter(const char* name) { StopEmitter(name); }
...
void idAI::Event_LaunchHomingMissile() {
  ...
  //	axis.Identity();
  if (!projectile.GetEntity()) {
    idHomingProjectile* homing =
        (idHomingProjectile*)CreateProjectile(org, idVec3(0.0f, 0.0f, 1.0f));
    if (homing != NULL) {
