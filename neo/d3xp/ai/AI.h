...
extern int Ballistics(const idVec3& start, const idVec3& end, float speed,
...
class idAASFindAttackPosition : public idAASCallback {
 public:
  idAASFindAttackPosition(const idAI* self, const idMat3& gravityAxis,
                          idEntity* target, const idVec3& targetPos,
...
class idAI : public idActor {
 public:
  ...
  bool GetAimDir(const idVec3& firePos, idEntity* aimAtEnt,
  ...
  static bool FindPathAroundObstacles(const idPhysics* physics,
                                      const idAAS* aas, const idEntity* ignore,
  ...
  static bool PredictPath(const idEntity* ent, const idAAS* aas,
  ...
  static bool TestTrajectory(const idVec3& start, const idVec3& end, float zVel,
  ...
  static bool PredictTrajectory(const idVec3& firePos, const idVec3& target,
 ...
 protected:
  ...
  virtual void Hide();
  virtual void Show();
  idVec3 FirstVisiblePointOnPath(const idVec3 origin, const idVec3& target,
  ...
  bool PathToGoal(aasPath_t& path, int areaNum, const idVec3& origin,
                  int goalAreaNum, const idVec3& goalOrigin) const;
  void DrawRoute() const;
  bool GetMovePos(idVec3& seekPos);
  bool MoveDone() const;
  bool EntityCanSeePos(idActor* actor, const idVec3& actorOrigin,
                       const idVec3& pos);
  ...
  idProjectile* LaunchProjectile(const char* jointname, idEntity* target,
  ...
  idEntity* StartEmitter(const char* name, const char* joint,
                         const char* particle);
  ...
  void Event_StartEmitter(const char* name, const char* joint,
                          const char* particle);
