...
============
*/
void idAASLocal::DrawCone(const idVec3& origin, const idVec3& dir, float radius,
...
void idAASLocal::DrawReachability(const idReachability* reach) const {
  ...
  switch (reach->travelType) {
    case TFL_WALK: {
      // const idReachability_Walk *walk = static_cast<const idReachability_Walk
      // *>(reach);
      break;
    }
    default: {
...
============
*/
void idAASLocal::ShowWalkPath(const idVec3& origin, int goalAreaNum,
...
============
*/
void idAASLocal::ShowFlyPath(const idVec3& origin, int goalAreaNum,
                             const idVec3& goalOrigin) const {
  int i, areaNum, curAreaNum, travelTime;
  idReachability* reach;
  idVec3 org, areaCenter;
