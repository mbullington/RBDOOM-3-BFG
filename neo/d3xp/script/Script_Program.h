...
class idTypeDef {
 ...
 public:
  ...
  idTypeDef(etype_t etype, idVarDef* edef, const char* ename, int esize,
            idTypeDef* aux);
...
class idProgram {
 ...
 public:
  ...
  idTypeDef* AllocType(etype_t etype, idVarDef* edef, const char* ename,
 ...
 public:
  ...
  idVarDef* AllocDef(idTypeDef* type, const char* name, idVarDef* scope,
                     bool constant);
  idVarDef* GetDef(const idTypeDef* type, const char* name,
                   const idVarDef* scope) const;
  void FreeDef(idVarDef* d, const idVarDef* scope);
  idVarDef* FindFreeResultDef(idTypeDef* type, const char* name,
