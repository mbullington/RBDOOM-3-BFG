...
class idCompiler {
 private:
  ...
  idVarDef* OptimizeOpcode(const opcode_t* op, idVarDef* var_a,
                           idVarDef* var_b);
  ...
  idTypeDef* CheckType();
  idTypeDef* ParseType();
  idVarDef* FindImmediate(const idTypeDef* type, const eval_t* eval,
                          const char* string) const;
  idVarDef* GetImmediate(idTypeDef* type, const eval_t* eval,
                         const char* string);
