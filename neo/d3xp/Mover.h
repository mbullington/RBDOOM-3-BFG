...
class idMover : public idEntity {
 ...
 private:
  ...
  void Event_PostRestore(int start, int total, int accel, int decel,
                         int useSplineAng);
  void Event_IsMoving();
...
class idMover_Binary : public idEntity {
 public:
  ...
  void Enable(bool b);
  void InitSpeed(idVec3& mpos1, idVec3& mpos2, float mspeed, float maccelTime,
                 float mdecelTime);
  void InitTime(idVec3& mpos1, idVec3& mpos2, float mtime, float maccelTime,
                float mdecelTime);
  void GotoPosition1();
  void GotoPosition2();
