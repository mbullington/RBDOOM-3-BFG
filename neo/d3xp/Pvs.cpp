...
===============
*/
void idPVS::AddPassageBoundaries(const idWinding& source, const idWinding& pass,
...
================
*/
bool idPVS::InCurrentPVS(const pvsHandle_t handle, const int* targetAreas,
