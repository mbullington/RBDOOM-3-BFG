...
void idMenuScreen_PDA_VideoDisks::Initialize(idMenuHandler* data) {
  ...
  while (pdaVideoList.GetChildren().Num() < MAX_VIDEO_ITEMS) {
    ...
    buttonWidget->AddEventAction(WIDGET_EVENT_PRESS)
        .Set(WIDGET_ACTION_SELECT_PDA_VIDEO, pdaVideoList.GetChildren().Num());
  ...
  AddEventAction(WIDGET_EVENT_SCROLL_DOWN_LSTICK)
      .Set(new (TAG_SWF) idWidgetActionHandler(
          &pdaVideoList, WIDGET_ACTION_EVENT_SCROLL_DOWN_START_REPEATER,
          WIDGET_EVENT_SCROLL_DOWN_LSTICK));
  AddEventAction(WIDGET_EVENT_SCROLL_UP_LSTICK)
      .Set(new (TAG_SWF) idWidgetActionHandler(
          &pdaVideoList, WIDGET_ACTION_EVENT_SCROLL_UP_START_REPEATER,
          WIDGET_EVENT_SCROLL_UP_LSTICK));
  AddEventAction(WIDGET_EVENT_SCROLL_DOWN_LSTICK_RELEASE)
      .Set(new (TAG_SWF) idWidgetActionHandler(
          &pdaVideoList, WIDGET_ACTION_EVENT_STOP_REPEATER,
  ...
  if (player != NULL) {
    ...
    if (player->GetVideoMaterial() != NULL) {
      ...
      if (BindSprite(root) && GetSprite() != NULL) {
        idSWFSpriteInstance* videoSprite =
            GetSprite()->GetScriptObject()->GetNestedSprite("info", "details",
                                                            "video", "img");
...
========================
*/
void idMenuScreen_PDA_VideoDisks::ShowScreen(
...
void idMenuScreen_PDA_VideoDisks::SelectedVideoToPlay(int index) {
  ...
  const idDeclVideo* video =
      player->GetVideo(pdaVideoList.GetViewOffset() + index);
...
========================
*/
void idMenuScreen_PDA_VideoDisks::HideScreen(
    const mainMenuTransition_t transitionType) {
...
========================
*/
bool idMenuScreen_PDA_VideoDisks::HandleAction(idWidgetAction& action,
