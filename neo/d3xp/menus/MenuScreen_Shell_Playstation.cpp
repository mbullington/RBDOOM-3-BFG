...
========================
*/
void idMenuScreen_Shell_Playstation::ShowScreen(
...
========================
*/
void idMenuScreen_Shell_Playstation::HideScreen(
    const mainMenuTransition_t transitionType) {
...
========================
*/
bool idMenuScreen_Shell_Playstation::HandleAction(idWidgetAction& action,
