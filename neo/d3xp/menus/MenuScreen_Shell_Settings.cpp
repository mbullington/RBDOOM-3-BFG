...
void idMenuScreen_Shell_Settings::Initialize(idMenuHandler* data) {
  ...
  while (options->GetChildren().Num() < NUM_SETTING_OPTIONS) {
    ...
    buttonWidget->AddEventAction(WIDGET_EVENT_PRESS)
        .Set(WIDGET_ACTION_COMMAND, options->GetChildren().Num());
...
========================
*/
void idMenuScreen_Shell_Settings::ShowScreen(
...
========================
*/
void idMenuScreen_Shell_Settings::HideScreen(
    const mainMenuTransition_t transitionType) {
...
========================
*/
bool idMenuScreen_Shell_Settings::HandleAction(idWidgetAction& action,
    ...
    case WIDGET_ACTION_COMMAND: {
      switch (parms[0].ToInteger()) {
        ...
        case SETTING_CMD_GAMEPLAY: {
          menuData->SetNextScreen(SHELL_AREA_GAME_OPTIONS,
        ...
        case SETTING_CMD_3D: {
          menuData->SetNextScreen(SHELL_AREA_STEREOSCOPICS,
                                  MENU_TRANSITION_SIMPLE);
          break;
        }
      }
