...
========================
*/
void idMenuScreen_Shell_Dev::ShowScreen(
...
========================
*/
void idMenuScreen_Shell_Dev::HideScreen(
    const mainMenuTransition_t transitionType) {
...
========================
*/
bool idMenuScreen_Shell_Dev::HandleAction(idWidgetAction& action,
  ...
  switch (actionType) {
    ...
    case WIDGET_ACTION_PRESS_FOCUSED: {
      ...
      if (options->GetFocusIndex() !=
          selectionIndex - options->GetViewOffset()) {
