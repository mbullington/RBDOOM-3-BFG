...
void idMenuScreen_Shell_Root::Initialize(idMenuHandler* data) {
  ...
  AddEventAction(WIDGET_EVENT_SCROLL_RIGHT)
      .Set(new (TAG_SWF) idWidgetActionHandler(
          this, WIDGET_ACTION_EVENT_SCROLL_RIGHT_START_REPEATER,
  ...
  AddEventAction(WIDGET_EVENT_SCROLL_LEFT)
      .Set(new (TAG_SWF) idWidgetActionHandler(
          this, WIDGET_ACTION_EVENT_SCROLL_LEFT_START_REPEATER,
  ...
  if (menuData != NULL && menuData->GetPlatform() != 2) {
    ...
    if (g_demoMode.GetBool()) {
      ...
      options->GetChildByIndex(index)
          ...
          .Set(WIDGET_ACTION_COMMAND, ROOT_CMD_START_DEMO);
      buttonWidget =
      ...
      if (g_demoMode.GetInteger() == 2) {
        ...
        options->GetChildByIndex(index)
            .AddEventAction(WIDGET_EVENT_PRESS)
            .Set(WIDGET_ACTION_COMMAND, ROOT_CMD_START_DEMO2);
      ...
      options->GetChildByIndex(index)
          .AddEventAction(WIDGET_EVENT_PRESS)
          .Set(WIDGET_ACTION_COMMAND, ROOT_CMD_SETTINGS);
      buttonWidget =
          dynamic_cast<idMenuWidget_Button*>(&options->GetChildByIndex(index));
      if (buttonWidget != NULL) {
      ...
      options->GetChildByIndex(index)
          .AddEventAction(WIDGET_EVENT_PRESS)
          .Set(WIDGET_ACTION_COMMAND, ROOT_CMD_QUIT);
      buttonWidget =
          dynamic_cast<idMenuWidget_Button*>(&options->GetChildByIndex(index));
      if (buttonWidget != NULL) {
      ...
      options->GetChildByIndex(index)
          .AddEventAction(WIDGET_EVENT_PRESS)
          .Set(WIDGET_ACTION_COMMAND, ROOT_CMD_DEV);
      buttonWidget =
          dynamic_cast<idMenuWidget_Button*>(&options->GetChildByIndex(index));
      if (buttonWidget != NULL) {
      ...
      options->GetChildByIndex(index)
          .AddEventAction(WIDGET_EVENT_PRESS)
          .Set(WIDGET_ACTION_COMMAND, ROOT_CMD_CAMPAIGN);
      buttonWidget =
          dynamic_cast<idMenuWidget_Button*>(&options->GetChildByIndex(index));
      if (buttonWidget != NULL) {
      ...
      options->GetChildByIndex(index)
          .AddEventAction(WIDGET_EVENT_PRESS)
          .Set(WIDGET_ACTION_COMMAND, ROOT_CMD_MULTIPLAYER);
      buttonWidget =
          dynamic_cast<idMenuWidget_Button*>(&options->GetChildByIndex(index));
      if (buttonWidget != NULL) {
      ...
      options->GetChildByIndex(index)
          .AddEventAction(WIDGET_EVENT_PRESS)
          .Set(WIDGET_ACTION_COMMAND, ROOT_CMD_CREDITS);
      buttonWidget =
          dynamic_cast<idMenuWidget_Button*>(&options->GetChildByIndex(index));
      if (buttonWidget != NULL) {
    ...
    case WIDGET_ACTION_PRESS_FOCUSED: {
      if (menuData->GetPlatform() == 2) {
        idMenuHandler_Shell* shell =
            dynamic_cast<idMenuHandler_Shell*>(menuData);
        if (!shell) {
          return true;
        }
        ...
        const idMenuWidget_MenuButton* buttonWidget =
      ...
      switch (parms[0].ToInteger()) {
        ...
        case ROOT_CMD_MULTIPLAYER: {
          ...
          if (masterUser->GetOnlineCaps() & CAP_BLOCKED_PERMISSION) {
            ...
            class idSWFScriptFunction_Cancel
                : public idSWFScriptFunction_RefCounted {
             public:
            ...
            common->Dialog().AddDialog(
                GDM_PLAY_ONLINE_NO_PROFILE, DIALOG_ACCEPT_CANCEL,
