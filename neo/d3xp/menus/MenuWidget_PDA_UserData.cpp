...
void idMenuWidget_PDA_UserData::Update() {
  ...
  if (dataObj != NULL && pda != NULL) {
    ...
    if (txtLocHeading != NULL) {
      if (pdaIndex == 0) {
        txtLocHeading->SetText(
            idLocalization::GetString("#str_02516"));  // location
      } else {
        txtLocHeading->SetText(
            idLocalization::GetString("#str_02515"));  // post
      }
    }
...
========================
*/
void idMenuWidget_PDA_UserData::ObserveEvent(const idMenuWidget& widget,
