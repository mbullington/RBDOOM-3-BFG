...
void idMenuScreen_Shell_ModeSelect::Initialize(idMenuHandler* data) {
  ...
  const char* tips[] = {"#str_swf_deathmatch_desc", "#str_swf_tourney_desc",
                        "#str_swf_team_deathmatch_desc",
                        "#str_swf_lastman_desc", "#str_swf_ctf_desc"};
...
========================
*/
void idMenuScreen_Shell_ModeSelect::ShowScreen(
...
========================
*/
void idMenuScreen_Shell_ModeSelect::HideScreen(
    const mainMenuTransition_t transitionType) {
...
========================
*/
bool idMenuScreen_Shell_ModeSelect::HandleAction(idWidgetAction& action,
