...
void idMenuScreen_Shell_Difficulty::Initialize(idMenuHandler* data) {
  ...
  options->AddEventAction(WIDGET_EVENT_SCROLL_DOWN)
      .Set(new (TAG_SWF) idWidgetActionHandler(
          options, WIDGET_ACTION_EVENT_SCROLL_DOWN_START_REPEATER_VARIABLE,
          WIDGET_EVENT_SCROLL_DOWN));
  options->AddEventAction(WIDGET_EVENT_SCROLL_UP)
      .Set(new (TAG_SWF) idWidgetActionHandler(
          options, WIDGET_ACTION_EVENT_SCROLL_UP_START_REPEATER_VARIABLE,
...
========================
*/
void idMenuScreen_Shell_Difficulty::HideScreen(
    const mainMenuTransition_t transitionType) {
...
========================
*/
bool idMenuScreen_Shell_Difficulty::HandleAction(idWidgetAction& action,
  ...
  switch (actionType) {
    case WIDGET_ACTION_SCROLL_VERTICAL_VARIABLE: {
      ...
      if ((curIndex + scroll < 0 && !nightmareEnabled) ||
          (curIndex + scroll == 3 && !nightmareEnabled)) {
        scroll *= 2;
