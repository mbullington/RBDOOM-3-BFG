...
struct columnGameMode_t {
  ...
  int numColumns;
  rankOrder_t rankOrder;  // rank ordering of the game mode. (
                          // RANK_GREATEST_FIRST, RANK_LEAST_FIRST )
...
// creates and stores all the leaderboards inside the internal map ( see
// Sys_FindLeaderboardDef on retrieving definition )
...
// Do it all function. Will create the column_t with the correct stats from the
// game type, and upload it to the leaderboard system.
