...
============
*/
void idPush::InitSavingPushedEntityPositions() { numPushed = 0; }
...
============
*/
bool idPush::CanPushEntity(idEntity* ent, idEntity* pusher,
                           idEntity* initialPusher, const int flags) {
...
============
*/
void idPush::AddEntityToPushedGroup(idEntity* ent, float fraction,
                                    bool groundContact) {
  int i, j;
...
============
*/
bool idPush::ClipTranslationAgainstPusher(trace_t& results, idEntity* ent,
                                          idEntity* pusher,
...
============
*/
int idPush::GetPushableEntitiesForTranslation(
    idEntity* pusher, idEntity* initialPusher, const int flags,
...
============
*/
float idPush::ClipTranslationalPush(trace_t& results, idEntity* pusher,
                                    const int flags, const idVec3& newOrigin,
                                    const idVec3& translation) {
...
============
*/
bool idPush::ClipRotationAgainstPusher(trace_t& results, idEntity* ent,
                                       idEntity* pusher,
...
============
*/
int idPush::GetPushableEntitiesForRotation(
    idEntity* pusher, idEntity* initialPusher, const int flags,
...
============
*/
float idPush::ClipRotationalPush(trace_t& results, idEntity* pusher,
                                 const int flags, const idMat3& newAxis,
                                 const idRotation& rotation) {
  int i, j, numListedEntities;
  idEntity *curPusher, *ent, *entityList[MAX_GENTITIES];
  float fraction;
...
============
*/
void idPush::ClipEntityRotation(trace_t& trace, const idEntity* ent,
...
============
*/
void idPush::ClipEntityTranslation(trace_t& trace, const idEntity* ent,
...
int idPush::TryRotatePushEntity(trace_t& results, idEntity* check,
                                idClipModel* clipModel, const int flags,
  ...
  newRotation.Set(rotation.GetOrigin(), rotation.GetVec(), checkAngle);
  // NOTE:	this code prevents msvc 6.0 & 7.0 from screwing up the above code
  // in
...
int idPush::TryTranslatePushEntity(trace_t& results, idEntity* check,
                                   idClipModel* clipModel, const int flags,
...
============
*/
int idPush::DiscardEntities(idEntity* entityList[], int numEntities, int flags,
                            idEntity* pusher) {
  int i, num;
  idEntity* check;
