...
class idAFConstraint_BallAndSocketJoint : public idAFConstraint {
 public:
  idAFConstraint_BallAndSocketJoint(const idStr& name, idAFBody* body1,
                                    idAFBody* body2);
...
class idAFConstraint_UniversalJoint : public idAFConstraint {
 public:
  idAFConstraint_UniversalJoint(const idStr& name, idAFBody* body1,
                                idAFBody* body2);
...
class idAFConstraint_CylindricalJoint : public idAFConstraint {
 public:
  idAFConstraint_CylindricalJoint(const idStr& name, idAFBody* body1,
                                  idAFBody* body2);
  virtual void DebugDraw();
  virtual void Translate(const idVec3& translation);
  virtual void Rotate(const idRotation& rotation);
...
class idAFConstraint_Spring : public idAFConstraint {
 public:
  ...
  void SetSpring(const float stretch, const float compress, const float damping,
...
class idAFConstraint_ConeLimit : public idAFConstraint {
 public:
  ...
  void Setup(idAFBody* b1, idAFBody* b2, const idVec3& coneAnchor,
             const idVec3& coneAxis, const float coneAngle,
             const idVec3& body1Axis);
...
class idAFConstraint_PyramidLimit : public idAFConstraint {
 public:
  ...
  void Setup(idAFBody* b1, idAFBody* b2, const idVec3& pyramidAnchor,
             ...
             const float pyramidAngle1, const float pyramidAngle2,
             const idVec3& body1Axis);
...
class idAFConstraint_Suspension : public idAFConstraint {
 public:
  ...
  void Setup(const char* name, idAFBody* body, const idVec3& origin,
             const idMat3& axis, idClipModel* clipModel);
  void SetSuspension(const float up, const float down, const float k,
...
class idAFBody {
 ...
 private:
  ...
  idList<idAFConstraint*, TAG_IDLIB_LIST_PHYSICS>
      constraints;        // all constraints attached to this body
...
class idPhysics_AF : public idPhysics_Base {
 public:
  ...
  void SetJointFrictionDent(const float dent, const float start,
                            const float end);
  ...
  void SetContactFrictionDent(const float dent, const float start,
                              const float end);
 ...
 public:  // common physics interface
  void SetClipModel(idClipModel* model, float density, int id = 0,
                    bool freeOld = true);
  ...
  void GetImpactInfo(const int id, const idVec3& point,
  ...
  void ClipRotation(trace_t& results, const idRotation& rotation,
                    const idClipModel* model) const;
 ...
 private:
  ...
  idList<idAFConstraint*, TAG_IDLIB_LIST_PHYSICS>
      constraints;  // all frame independent constraints
  idList<idAFConstraint*, TAG_IDLIB_LIST_PHYSICS>
      primaryConstraints;  // list with primary constraints
  idList<idAFConstraint*, TAG_IDLIB_LIST_PHYSICS>
      auxiliaryConstraints;  // list with auxiliary constraints
  idList<idAFConstraint*, TAG_IDLIB_LIST_PHYSICS>
      frameConstraints;  // constraints that only live one frame
  idList<idAFConstraint_Contact*, TAG_IDLIB_LIST_PHYSICS>
      contactConstraints;  // contact constraints
  idList<int, TAG_IDLIB_LIST_PHYSICS>
      contactBodies;  // body id for each contact
