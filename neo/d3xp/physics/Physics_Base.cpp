...
================
*/
void idPhysics_Base::SetClipModel(idClipModel* model, float density, int id,
                                  bool freeOld) {}
...
================
*/
idClipModel* idPhysics_Base::GetClipModel(int id) const { return NULL; }
...
================
*/
int idPhysics_Base::GetNumClipModels() const { return 0; }
...
================
*/
float idPhysics_Base::GetMass(int id) const { return 0.0f; }
...
================
*/
void idPhysics_Base::SetClipMask(int mask, int id) { clipMask = mask; }
...
================
*/
int idPhysics_Base::GetClipMask(int id) const { return clipMask; }
...
================
*/
const idBounds& idPhysics_Base::GetBounds(int id) const { return bounds_zero; }
...
================
*/
bool idPhysics_Base::Interpolate(const float fraction) { return false; }
...
================
*/
void idPhysics_Base::ResetInterpolationState(const idVec3& origin,
                                             const idMat3& axis) {}
...
================
*/
int idPhysics_Base::GetTime() const { return 0; }
...
================
*/
void idPhysics_Base::GetImpactInfo(const int id, const idVec3& point,
...
================
*/
void idPhysics_Base::ApplyImpulse(const int id, const idVec3& point,
...
================
*/
void idPhysics_Base::AddForce(const int id, const idVec3& point,
                              const idVec3& force) {}
...
================
*/
bool idPhysics_Base::IsAtRest() const { return true; }
...
================
*/
int idPhysics_Base::GetRestStartTime() const { return 0; }
...
================
*/
bool idPhysics_Base::IsPushable() const { return true; }
...
================
*/
const idVec3& idPhysics_Base::GetOrigin(int id) const { return vec3_origin; }
...
================
*/
const idMat3& idPhysics_Base::GetAxis(int id) const { return mat3_identity; }
...
================
*/
const idVec3& idPhysics_Base::GetGravity() const { return gravityVector; }
...
================
*/
const idVec3& idPhysics_Base::GetGravityNormal() const { return gravityNormal; }
...
================
*/
void idPhysics_Base::ClipRotation(trace_t& results, const idRotation& rotation,
                                  const idClipModel* model) const {
  memset(&results, 0, sizeof(trace_t));
}
...
================
*/
int idPhysics_Base::ClipContents(const idClipModel* model) const { return 0; }
...
================
*/
bool idPhysics_Base::EvaluateContacts() { return false; }
...
================
*/
int idPhysics_Base::GetNumContacts() const { return contacts.Num(); }
...
================
*/
const trace_t* idPhysics_Base::GetBlockingInfo() const { return NULL; }
...
================
*/
idEntity* idPhysics_Base::GetBlockingEntity() const { return NULL; }
...
================
*/
int idPhysics_Base::GetLinearEndTime() const { return 0; }
...
================
*/
int idPhysics_Base::GetAngularEndTime() const { return 0; }
...
================
*/
void idPhysics_Base::DrawVelocity(int id, float linearScale,
