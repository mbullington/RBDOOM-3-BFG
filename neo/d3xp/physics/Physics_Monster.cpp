...
=====================
*/
monsterMoveResult_t idPhysics_Monster::StepMove(idVec3& start, idVec3& velocity,
                                                const idVec3& delta) {
  trace_t tr;
...
================
*/
void idPhysics_Monster::PutToRest() { Rest(); }
...
================
*/
float idPhysics_Monster::GetMaxStepHeight() const { return maxStepHeight; }
...
================
*/
bool idPhysics_Monster::OnGround() const { return current.onGround; }
...
================
*/
void idPhysics_Monster::ForceDeltaMove(bool force) { forceDeltaMove = force; }
...
================
*/
void idPhysics_Monster::UseFlyMove(bool force) { fly = force; }
...
================
*/
void idPhysics_Monster::UseVelocityMove(bool force) { useVelocityMove = force; }
...
================
*/
void idPhysics_Monster::EnableImpact() { noImpact = false; }
...
================
*/
void idPhysics_Monster::DisableImpact() { noImpact = true; }
...
================
*/
int idPhysics_Monster::GetTime() const { return gameLocal.time; }
...
================
*/
void idPhysics_Monster::GetImpactInfo(const int id, const idVec3& point,
...
================
*/
void idPhysics_Monster::ApplyImpulse(const int id, const idVec3& point,
...
================
*/
bool idPhysics_Monster::IsAtRest() const { return current.atRest >= 0; }
...
================
*/
int idPhysics_Monster::GetRestStartTime() const { return current.atRest; }
...
================
*/
void idPhysics_Monster::SaveState() { saved = current; }
