...
================
*/
const idMat3& idPhysics_Actor::GetGravityAxis() const { return clipModelAxis; }
...
================
*/
void idPhysics_Actor::SetClipModel(idClipModel* model, const float density,
                                   int id, bool freeOld) {
  assert(self);
...
================
*/
idClipModel* idPhysics_Actor::GetClipModel(int id) const { return clipModel; }
...
================
*/
int idPhysics_Actor::GetNumClipModels() const { return 1; }
...
================
*/
float idPhysics_Actor::GetMass(int id) const { return mass; }
...
================
*/
bool idPhysics_Actor::IsPushable() const { return (masterEntity == NULL); }
...
================
*/
void idPhysics_Actor::ClipRotation(trace_t& results, const idRotation& rotation,
                                   const idClipModel* model) const {
  if (model) {
...
================
*/
void idPhysics_Actor::DisableClip() { clipModel->Disable(); }
...
================
*/
void idPhysics_Actor::EnableClip() { clipModel->Enable(); }
...
================
*/
void idPhysics_Actor::UnlinkClip() { clipModel->Unlink(); }
