...
================
*/
void idPhysics_StaticMulti::SetClipModel(idClipModel* model, float density,
                                         int id, bool freeOld) {
  int i;
...
================
*/
int idPhysics_StaticMulti::GetNumClipModels() const { return clipModels.Num(); }
...
================
*/
float idPhysics_StaticMulti::GetMass(int id) const { return 0.0f; }
...
================
*/
int idPhysics_StaticMulti::GetClipMask(int id) const { return 0; }
...
================
*/
int idPhysics_StaticMulti::GetTime() const { return 0; }
...
================
*/
void idPhysics_StaticMulti::GetImpactInfo(const int id, const idVec3& point,
...
================
*/
void idPhysics_StaticMulti::ApplyImpulse(const int id, const idVec3& point,
...
================
*/
void idPhysics_StaticMulti::AddForce(const int id, const idVec3& point,
                                     const idVec3& force) {}
...
================
*/
bool idPhysics_StaticMulti::IsAtRest() const { return true; }
...
================
*/
int idPhysics_StaticMulti::GetRestStartTime() const { return 0; }
...
================
*/
bool idPhysics_StaticMulti::IsPushable() const { return false; }
...
================
*/
int idPhysics_StaticMulti::GetNumContacts() const { return 0; }
...
================
*/
bool idPhysics_StaticMulti::HasGroundContacts() const { return false; }
...
================
*/
const trace_t* idPhysics_StaticMulti::GetBlockingInfo() const { return NULL; }
...
================
*/
idEntity* idPhysics_StaticMulti::GetBlockingEntity() const { return NULL; }
...
================
*/
int idPhysics_StaticMulti::GetLinearEndTime() const { return 0; }
...
================
*/
int idPhysics_StaticMulti::GetAngularEndTime() const { return 0; }
