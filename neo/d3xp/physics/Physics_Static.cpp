...
================
*/
void idPhysics_Static::SetClipModel(idClipModel* model, float density, int id,
                                    bool freeOld) {
  assert(self);
...
================
*/
int idPhysics_Static::GetNumClipModels() const { return (clipModel != NULL); }
...
================
*/
float idPhysics_Static::GetMass(int id) const { return 0.0f; }
...
================
*/
int idPhysics_Static::GetClipMask(int id) const { return 0; }
...
================
*/
int idPhysics_Static::GetTime() const { return 0; }
...
================
*/
void idPhysics_Static::GetImpactInfo(const int id, const idVec3& point,
...
================
*/
void idPhysics_Static::ApplyImpulse(const int id, const idVec3& point,
...
================
*/
void idPhysics_Static::AddForce(const int id, const idVec3& point,
                                const idVec3& force) {}
...
================
*/
bool idPhysics_Static::IsAtRest() const { return true; }
...
================
*/
int idPhysics_Static::GetRestStartTime() const { return 0; }
...
================
*/
bool idPhysics_Static::IsPushable() const { return false; }
...
================
*/
const idMat3& idPhysics_Static::GetAxis(int id) const { return current.axis; }
...
================
*/
int idPhysics_Static::GetNumContacts() const { return 0; }
...
================
*/
bool idPhysics_Static::HasGroundContacts() const { return false; }
...
================
*/
bool idPhysics_Static::IsGroundEntity(int entityNum) const { return false; }
...
================
*/
const trace_t* idPhysics_Static::GetBlockingInfo() const { return NULL; }
...
================
*/
idEntity* idPhysics_Static::GetBlockingEntity() const { return NULL; }
...
================
*/
int idPhysics_Static::GetLinearEndTime() const { return 0; }
...
================
*/
int idPhysics_Static::GetAngularEndTime() const { return 0; }
...
================
*/
staticPState_s ConvertInterpolateStateToPState(
    const staticInterpolatePState_t& interpolateState) {
...
================
*/
staticInterpolatePState_t ConvertPStateToInterpolateState(
    const staticPState_t& state) {
...
================
*/
staticInterpolatePState_t ReadStaticInterpolatePStateFromSnapshot(
    const idBitMsg& msg) {
...
================
*/
staticPState_t InterpolateStaticPState(
    const staticInterpolatePState_t& previous,
    const staticInterpolatePState_t& next, float fraction) {
  ...
  result.localAxis =
      idQuat().Slerp(previous.localAxis, next.localAxis, fraction).ToMat3();
