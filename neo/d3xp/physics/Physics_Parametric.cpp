...
================
*/
void idPhysics_Parametric::SetLinearInterpolation(int time, int accelTime,
                                                  int decelTime, int duration,
...
================
*/
void idPhysics_Parametric::SetAngularInterpolation(int time, int accelTime,
                                                   int decelTime, int duration,
...
================
*/
void idPhysics_Parametric::SetClipModel(idClipModel* model, float density,
                                        int id, bool freeOld) {
  assert(self);
  assert(model);
...
================
*/
float idPhysics_Parametric::GetMass(int id) const { return 0.0f; }
...
bool idPhysics_Parametric::Interpolate(const float fraction) {
  ...
  const bool hasChanged =
      InterpolatePhysicsState(current, previous, next, fraction);
...
================
*/
int idPhysics_Parametric::GetTime() const { return current.time; }
...
================
*/
bool idPhysics_Parametric::IsAtRest() const { return current.atRest >= 0; }
...
================
*/
int idPhysics_Parametric::GetRestStartTime() const { return current.atRest; }
...
================
*/
bool idPhysics_Parametric::IsPushable() const { return false; }
