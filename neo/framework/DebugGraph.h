...
/*
================================================
The *Debug Graph, idDebugGraph, contains graphing functionality common to many
debug tools.
================================================
*/
class idDebugGraph {
 public:
  ...
  // the border specifies the amount of space between bars as well as the amount
  // of space around the entire graph
