...
idCVar com_product_lang_ext("com_product_lang_ext", "1",
...
int LocalizeMap(const char* mapName, idLangDict& langDict, ListHash& listHash,
                idStrList& excludeList, bool writeFile) {
...
CONSOLE_COMMAND(localizeGuiParmsTest,
...
CONSOLE_COMMAND(localizeMapsTest,
