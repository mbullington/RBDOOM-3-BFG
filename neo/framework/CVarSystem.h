...
typedef enum {
  ...
  // original doom3 used to have CVAR_USERINFO ("sent to servers, available to
  // menu") here
...
class idCVar {
 public:
  ...
  idCVar(const char* name, const char* value, int flags,
         const char* description, argCompletion_t valueCompletion = NULL);
  idCVar(const char* name, const char* value, int flags,
...
class idCVarSystem {
 public:
  ...
  virtual void SetCVarString(const char* name, const char* value,
                             int flags = 0) = 0;
  virtual void SetCVarBool(const char* name, const bool value,
                           int flags = 0) = 0;
  virtual void SetCVarInteger(const char* name, const int value,
                              int flags = 0) = 0;
  virtual void SetCVarFloat(const char* name, const float value,
                            int flags = 0) = 0;
  ...
  virtual void MoveCVarsToDict(int flags, idDict& dict,
                               bool onlyModified = false) const = 0;
