...
class idCommon {
 public:
  ...
  // the view angle for screenshots Redraws the screen, handling games, guis,
  // console, etc in a modal manner outside the normal frame loop
  ...
  virtual void Error(VERIFY_FORMAT_STRING const char* fmt, ...)
      ID_INSTANCE_ATTRIBUTE_PRINTF(1, 2) = 0;
