...
const int BUILD_NUMBER_SAVE_VERSION_CHANGE =
    1401;  // Altering saves so that the version goes in the Details file that
           // we read in during the enumeration phase
