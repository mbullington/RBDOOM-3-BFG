...
typedef bool (*getJointTransform_t)(void* model, const idJointMat* frame,
...
class idAFVector {
 ...
 public:
  ...
  bool Finish(const char* fileName, const getJointTransform_t GetJointTransform,
              const idJointMat* frame, void* model) const;
