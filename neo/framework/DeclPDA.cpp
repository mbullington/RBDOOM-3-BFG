...
idCVar g_useOldPDAStrings(
    "g_useOldPDAStrings", "0", CVAR_BOOL,
    "Read strings from the .pda files rather than from the .lang file");
...
=================
*/
size_t idDeclPDA::Size() const { return sizeof(idDeclPDA); }
...
===============
*/
void idDeclPDA::Print() const { common->Printf("Implement me\n"); }
...
===============
*/
void idDeclPDA::List() const { common->Printf("Implement me\n"); }
...
bool idDeclPDA::Parse(const char* text, const int textLength,
  ...
  while (1) {
    ...
    if (!token.Icmp("pda_audio")) {
      src.ReadToken(&token);
      audios.Append(static_cast<const idDeclAudio*>(
...
=================
*/
void idDeclPDA::SetSecurity(const char* sec) const { security = sec; }
...
=================
*/
size_t idDeclEmail::Size() const { return sizeof(idDeclEmail); }
...
===============
*/
void idDeclEmail::Print() const { common->Printf("Implement me\n"); }
...
===============
*/
void idDeclEmail::List() const { common->Printf("Implement me\n"); }
...
=================
*/
size_t idDeclVideo::Size() const { return sizeof(idDeclVideo); }
...
===============
*/
void idDeclVideo::Print() const { common->Printf("Implement me\n"); }
...
===============
*/
void idDeclVideo::List() const { common->Printf("Implement me\n"); }
...
=================
*/
size_t idDeclAudio::Size() const { return sizeof(idDeclAudio); }
...
===============
*/
void idDeclAudio::Print() const { common->Printf("Implement me\n"); }
...
===============
*/
void idDeclAudio::List() const { common->Printf("Implement me\n"); }
