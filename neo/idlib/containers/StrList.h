...
// actual strings and sorts the pointer list. Then copies the strings into
// another list using the ordered list of pointers.
//================
//*/
// template<>
...
// idStrListSortPaths
//
// Sorts the list of path strings alphabetically and makes sure folders come
// first.
//================
//*/
