...
=============
*/
int idWinding::Split(const idPlane& plane, const float epsilon,
                     idWinding** front, idWinding** back) const {
  float* dists;
  byte* sides;
  int counts[3];
  float dot;
...
=============
*/
idWinding* idWinding::Clip(const idPlane& plane, const float epsilon,
                           const bool keepOn) {
  float* dists;
  byte* sides;
  idVec5* newPoints;
...
=============
*/
bool idWinding::ClipInPlace(const idPlane& plane, const float epsilon,
                            const bool keepOn) {
  float* dists;
  byte* sides;
  idVec5* newPoints;
...
=============
*/
void idWinding::AddToConvexHull(const idWinding* winding, const idVec3& normal,
                                const float epsilon) {
  int i, j, k;
  idVec3 dir;
  float d;
...
=============
*/
void idWinding::AddToConvexHull(const idVec3& point, const idVec3& normal,
                                const float epsilon) {
...
idWinding* idWinding::TryMerge(const idWinding& w, const idVec3& planenormal,
                               int keep) const {
...
=============
*/
bool idWinding::InsertPointIfOnEdge(const idVec5& point, const idPlane& plane,
                                    const float epsilon) {
  int i;
  float dist, dot;
  idVec3 normal;
...
=============
*/
bool idWinding::InsertPointIfOnEdge(const idVec3& point, const idPlane& plane,
                                    const float epsilon) {
  int i;
  float dist, dot;
  idVec3 normal;
...
bool idWinding::PlanesConcave(const idWinding& w2, const idVec3& normal1,
                              const idVec3& normal2, float dist1,
                              float dist2) const {
  int i;
...
=============
*/
bool idWinding::PointInside(const idVec3& normal, const idVec3& point,
...
bool idWinding::RayIntersection(const idPlane& windingPlane,
                                const idVec3& start, const idVec3& dir,
                                float& scale, bool backFaceCull) const {
  int i;
...
=================
*/
float idWinding::TriangleArea(const idVec3& a, const idVec3& b,
                              const idVec3& c) {
  idVec3 v1, v2;
  idVec3 cross;
...
=============
*/
int idFixedWinding::Split(idFixedWinding* back, const idPlane& plane,
                          const float epsilon) {
  int counts[3];
