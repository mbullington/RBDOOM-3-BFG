...
class idWinding2D {
 public:
  ...
  int Split(const idVec3& plane, const float epsilon, idWinding2D** front,
  ...
  bool RayIntersection(const idVec2& start, const idVec2& dir, float& scale1,
                       float& scale2, int* edgeNums = NULL) const;

  static idVec3 Plane2DFromPoints(const idVec2& start, const idVec2& end,
                                  const bool normalize = false);
  static idVec3 Plane2DFromVecs(const idVec2& start, const idVec2& dir,
                                const bool normalize = false);
  static bool Plane2DIntersection(const idVec3& plane1, const idVec3& plane2,
                                  idVec2& point);
...
inline idWinding2D::idWinding2D() { numPoints = 0; }
...
inline idVec2& idWinding2D::operator[](const int index) { return p[index]; }

inline void idWinding2D::Clear() { numPoints = 0; }

inline void idWinding2D::AddPoint(const idVec2& point) {
  p[numPoints++] = point;
}

inline int idWinding2D::GetNumPoints() const { return numPoints; }

inline idVec3 idWinding2D::Plane2DFromPoints(const idVec2& start,
                                             const idVec2& end,
...
inline idVec3 idWinding2D::Plane2DFromVecs(const idVec2& start,
                                           const idVec2& dir,
                                           const bool normalize) {
  idVec3 plane;
  plane.x = -dir.y;
...
inline bool idWinding2D::Plane2DIntersection(const idVec3& plane1,
                                             const idVec3& plane2,
                                             idVec2& point) {
