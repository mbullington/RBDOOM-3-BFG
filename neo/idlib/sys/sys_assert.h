...
Getting assert() to work as we want on all platforms and code analysis tools can
be tricky.
...
// ai debugging macros (designed to limit ai interruptions to non-ai
// programmers)
#ifdef _DEBUG
