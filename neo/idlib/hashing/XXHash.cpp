...
uint32_t XXHash_Checksum(const void* data, int length) {
  return sx_hash_xxh32(data, length, 0);
}

uint64_t XXHash_Checksum_64(const void* data, int length) {
  return sx_hash_xxh64(data, length, 0);
}
