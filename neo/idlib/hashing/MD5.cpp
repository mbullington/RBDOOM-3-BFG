...
// JDC: I wouldn't have condoned the change in something as sensitive as a hash
// function, but it looks ok and a random test function checked it out.
//------------------------
...
The core of the MD5 algorithm, this alters an existing MD5 hash to reflect the
addition of 16 longwords of new data. MD5Update blocks the data and converts
...
digest and zero-izing the context.
========================
*/
