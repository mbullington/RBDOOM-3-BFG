...
============
*/
const char* idSIMD_Generic::GetName() const { return "generic code"; }
...
============
*/
void VPCALL idSIMD_Generic::MinMax(float& min, float& max, const float* src,
                                   const int count) {
...
============
*/
void VPCALL idSIMD_Generic::MinMax(idVec2& min, idVec2& max, const idVec2* src,
                                   const int count) {
...
============
*/
void VPCALL idSIMD_Generic::MinMax(idVec3& min, idVec3& max, const idVec3* src,
                                   const int count) {
...
============
*/
void VPCALL idSIMD_Generic::MinMax(idVec3& min, idVec3& max,
...
void VPCALL idSIMD_Generic::MinMax(idVec3& min, idVec3& max,
                                   ...
                                   const triIndex_t* indexes, const int count) {
  min[0] = min[1] = min[2] = idMath::INFINITUM;
  max[0] = max[1] = max[2] = -idMath::INFINITUM;
#define OPER(X)                            \
...
================
*/
void VPCALL idSIMD_Generic::Memcpy(void* dst, const void* src,
                                   const int count) {
...
============
*/
void VPCALL idSIMD_Generic::BlendJointsFast(idJointQuat* joints,
                                            const idJointQuat* blendJoints,
                                            const float lerp, const int* index,
                                            const int numJoints) {
  for (int i = 0; i < numJoints; i++) {
...
============
*/
void VPCALL idSIMD_Generic::ConvertJointQuatsToJointMats(
...
============
*/
void VPCALL idSIMD_Generic::ConvertJointMatsToJointQuats(
