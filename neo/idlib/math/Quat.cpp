...
=====================
*/
idAngles idQuat::ToAngles() const { return ToMat3().ToAngles(); }
...
=====================
*/
idMat4 idQuat::ToMat4() const { return ToMat3().ToMat4(); }
...
Approximation of spherical linear interpolation between two quaternions. The
interpolation traces out the exact same curve as Slerp but does not maintain a
constant speed across the arc.
========================
*/
...
=============
*/
idAngles idCQuat::ToAngles() const { return ToQuat().ToAngles(); }
...
=============
*/
idRotation idCQuat::ToRotation() const { return ToQuat().ToRotation(); }
...
=============
*/
idMat3 idCQuat::ToMat3() const { return ToQuat().ToMat3(); }
...
=============
*/
idMat4 idCQuat::ToMat4() const { return ToQuat().ToMat4(); }
