...
ID_INLINE const idVec3& idRotation::GetOrigin() const { return origin; }

ID_INLINE const idVec3& idRotation::GetVec() const { return vec; }

ID_INLINE float idRotation::GetAngle() const { return angle; }
