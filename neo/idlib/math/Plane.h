...
class idPlane {
 public:
  ...
  explicit idPlane(const idVec3& v0, const idVec3& v1, const idVec3& v2,
                   bool fixDegenerate = false);
  ...
  bool Compare(const idPlane& p, const float normalEps,
  ...
  bool FromPoints(const idVec3& p1, const idVec3& p2, const idVec3& p3,
                  bool fixDegenerate = true);
  bool FromVecs(const idVec3& dir1, const idVec3& dir2, const idVec3& p,
                bool fixDegenerate = true);
  ...
  bool RayIntersection(const idVec3& start, const idVec3& dir,
                       float& scale) const;
  bool PlaneIntersection(const idPlane& plane, idVec3& start,
                         idVec3& dir) const;
