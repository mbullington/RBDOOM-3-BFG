...
============
*/
idAngles idRotation::ToAngles() const { return ToMat3().ToAngles(); }
...
============
*/
idMat4 idRotation::ToMat4() const { return ToMat3().ToMat4(); }
...
============
*/
idVec3 idRotation::ToAngularVelocity() const { return vec * DEG2RAD(angle); }
