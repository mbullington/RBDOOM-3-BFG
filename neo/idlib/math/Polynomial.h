...
class idPolynomial {
 public:
  ...
  idPolynomial GetDerivative()
      const;  // get the first derivative of the polynomial
  idPolynomial GetAntiDerivative()
      const;  // get the anti derivative of the polynomial
  ...
  static int GetRoots4(float a, float b, float c, float d, float e,
                       float* roots);
