...
const __m128 idMath::SIMD_SP_min_short = {-32768.0f, -32768.0f, -32768.0f,
                                          -32768.0f};
const __m128 idMath::SIMD_SP_max_short = {32767.0f, 32767.0f, 32767.0f,
                                          32767.0f};
const __m128 idMath::SIMD_SP_smallestNonDenorm = {
    FLT_SMALLEST_NON_DENORMAL, FLT_SMALLEST_NON_DENORMAL,
    FLT_SMALLEST_NON_DENORMAL, FLT_SMALLEST_NON_DENORMAL};
...
int idMath::FloatToBits(float f, int exponentBits, int mantissaBits) {
  ...
  value |= ((INT32_SIGNBITSET(exponent) << exponentBits) |
