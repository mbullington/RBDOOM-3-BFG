...
idVec6 vec6_infinity(idMath::INFINITUM, idMath::INFINITUM, idMath::INFINITUM,
...
// A Survey of Efficient Representations for Independent Unit Vectors, Journal
// of Computer Graphics Techniques (JCGT), vol. 3, no. 2, 1-30, 2014 Available
// online http://jcgt.org/published/0003/02/01/

inline float signNotZero(float k) { return (k >= 0.0f) ? 1.0f : -1.0f; }
