...
class idDataQueue {
 public:
  ...
  bool Append(int sequence, const byte* b1, int b1Len, const byte* b2 = NULL,
              int b2Len = 0);
...
*/
template <int maxItems, int maxBuffer>
bool idDataQueue<maxItems, maxBuffer>::Append(int sequence, const byte* b1,
                                              int b1Len, const byte* b2,
                                              int b2Len) {
