...
thread_local bool idLib::isMainThread = 0;
...
#if !defined(_WIN32)
  // SRS - Added exit to silence build warning since FatalError has attribute
  // noreturn
  exit(EXIT_FAILURE);
#endif
}
...
================
*/
void RevBytesNoSwap(void* bp, int elsize, int elcount) { return; }
...
/*
 ...
 ================
 */
void RevBitFieldNoSwap(void* bp, int elsize) { return; }
