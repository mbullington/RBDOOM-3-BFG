...
/*
================================================================================================
This file defines a set of template functors for generating callbacks,
specifically the OnChange handlers in the CVar system.
================================================================================================
*/
...
Callback class that forwards the call to a member function with an additional
constant parameter
================================================
*/
...
class idCallbackBindMemArg1 : public idCallback {
 ...
 private:
  ...
  // with this on the PC, the MakeCallback function fails compilation because
  // it's returning a copy therefore, the Arg1 callbacks can't have arguments
  // that are references
...
================================================================================================
        ...
        These are needed because we can't derive the type of an object from the
type passed to the constructor. If it weren't for these, we'd have to manually
specify the type:
...
========================
*/
extern inline idCallbackStatic MakeCallback(void (*f)()) {
...
*/
template <class T>
extern inline idCallbackBindMem<T> MakeCallback(T* t, void (T::*f)()) {
...
*/
template <class T, typename A1>
extern inline idCallbackBindMemArg1<T, A1> MakeCallback(T* t, void (T::*f)(A1),
                                                        A1 a1) {
