...
// a GUI light editor, based loosely on the one from original Doom3
// (neo/tools/radiant/LightDlg.*) LightInfo was CLightInfo, the LightEditor
// itself was written from scratch.
...
class LightEditor {
 private:
  ...
  static LightEditor TheLightEditor;  // FIXME: maybe at some point we could
                                      // allow more than one..
