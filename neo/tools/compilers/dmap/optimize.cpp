...
static bool IsTriangleValid(const optVertex_t* v1, const optVertex_t* v2,
                            const optVertex_t* v3);
static bool IsTriangleDegenerate(const optVertex_t* v1, const optVertex_t* v2,
                                 const optVertex_t* v3);
...
=================
*/
static bool VertexBetween(const optVertex_t* p1, const optVertex_t* v1,
...
====================
*/
static bool PointsStraddleLine(optVertex_t* p1, optVertex_t* p2,
                               optVertex_t* l1, optVertex_t* l2) {
  bool t1, t2;
...
====================
*/
static bool EdgesCross(optVertex_t* a1, optVertex_t* a2, optVertex_t* b1,
                       optVertex_t* b2) {
...
====================
*/
static bool TryAddNewEdge(optVertex_t* v1, optVertex_t* v2,
                          optIsland_t* island) {
  optEdge_t* e;
...
==================
*/
static bool PointInTri(const idVec3& p, const mapTri_t* tri,
                       optIsland_t* island) {
  idVec3 d1, d2, normal;
...
===============
*/
static void CreateOptTri(optVertex_t* first, optEdge_t* e1, optEdge_t* e2,
                         optIsland_t* island) {
...
static void BuildOptTriangles(optIsland_t* island) {
  ...
  optEdge_t *e1 = NULL, *e1Next = NULL, *e2 = NULL, *e2Next = NULL,
            *check = NULL, *checkNext = NULL;
...
static void AddOriginalEdges(optimizeGroup_t* opt) {
  ...
  originalEdges = (originalEdges_t*)Mem_Alloc(
      numTris * 3 * sizeof(*originalEdges), TAG_TOOLS);
  numOriginalEdges = 0;
...
void SplitOriginalEdgesAtCrossings(optimizeGroup_t* opt) {
  ...
  crossings = (edgeCrossing_t**)Mem_ClearedAlloc(
      numOriginalEdges * sizeof(*crossings), TAG_TOOLS);
