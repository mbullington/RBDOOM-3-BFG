...
============
*/
int idBrushSide::Split(const idPlane& splitPlane, idBrushSide** front,
...
============
*/
int idBrush::Split(const idPlane& plane, int planeNum, idBrush** front,
                   idBrush** back) const {
  int res, i, j;
...
============
*/
void idBrushList::Split(const idPlane& plane, int planeNum,
                        idBrushList& frontList, idBrushList& backList,
