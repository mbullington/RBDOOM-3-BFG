...
class idLedge {
 ...
 public:
  idLedge();
  idLedge(const idVec3& v1, const idVec3& v2, const idVec3& gravityDir,
          idBrushBSPNode* n);
...
class idAASBuild {
 ...
 private:  // map loading
  ...
  void DeleteProcBSP();
  bool ChoppedAwayByProcBSP(int nodeNum, idFixedWinding* w,
  ...
  idBrushList AddBrushesForMapPatch(const idMapPatch* mapPatch,
                                    ...
                                    int entityNum, int primitiveNum,
                                    idBrushList brushList);
  idBrushList AddBrushesForMapEntity(const idMapEntity* mapEnt, int entityNum,
                                     idBrushList brushList);
 ...
 private:  // ledge subdivision
  ...
  bool IsLedgeSide_r(idBrushBSPNode* node, idFixedWinding* w,
                     const idPlane& plane, const idVec3& normal,
 ...
 private:  // storing file
  ...
  void GetSizeEstimate_r(idBrushBSPNode* parent, idBrushBSPNode* node,
