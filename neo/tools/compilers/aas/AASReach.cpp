...
================
*/
inline bool idAASReach::CanSwimInArea(int areaNum) {
...
================
*/
inline bool idAASReach::AreaHasFloor(int areaNum) {
...
================
*/
inline bool idAASReach::AreaIsClusterPortal(int areaNum) {
...
void idAASReach::Reachability_EqualFloorHeight(int areaNum) {
  int i, k, l, m, n, faceNum, face1Num, face2Num, otherAreaNum, edge1Num = 0,
                                                                edge2Num;
...
bool idAASReach::Reachability_Step_Barrier_WaterJump_WalkOffLedge(
    int area1num, int area2num) {
  int i, j, k, l, edge1Num, edge2Num, areas[10];
  int floor_bestArea1FloorEdgeNum = 0, floor_bestArea2FloorEdgeNum,
      floor_foundReach;
