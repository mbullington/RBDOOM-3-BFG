...
============
*/
int idBrushBSPPortal::Split(const idPlane& splitPlane, idBrushBSPPortal** front,
...
============
*/
inline bool idBrushBSP::IsValidSplitter(const idBrushSide* side) {
...
int idBrushBSP::BrushSplitterStats(const idBrush* brush, int planeNum,
...
============
*/
int idBrushBSP::FindSplitter(idBrushBSPNode* node, const idPlaneSet& planeList,
                             bool* testedPlanes,
...
============
*/
void idBrushBSP::WriteBrushMap(const idStr& fileName, const idStr& ext,
                               int contents) {
...
============
*/
void idBrushBSP::FloodThroughPortals_r(idBrushBSPNode* node, int contents,
                                       int depth) {
  idBrushBSPPortal* p;
  int s;
...
============
*/
bool idBrushBSP::FloodFromEntities(const idMapFile* mapFile, int contents,
...
============
*/
bool idBrushBSP::RemoveOutside(const idMapFile* mapFile, int contents,
                               const idStrList& classNames) {
...
============
*/
void idBrushBSP::SetPortalPlanes() { SetPortalPlanes_r(root, portalPlanes); }
...
============
*/
void idBrushBSP::MeltFlood_r(idBrushBSPNode* node, int skipContents,
                             idBounds& bounds,
...
============
*/
void idBrushBSP::MeltLeafNodePortals(idBrushBSPNode* node, int skipContents,
                                     idVectorSet<idVec3, 3>& vertexList) {
  int s1, i;
  idBrushBSPPortal* p1;
  idBounds bounds;
...
============
*/
void idBrushBSP::MeltPortals_r(idBrushBSPNode* node, int skipContents,
                               idVectorSet<idVec3, 3>& vertexList) {
  if (!node) {
    return;
  }
