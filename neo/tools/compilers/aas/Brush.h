...
class idBrushSide {
 ...
 public:
  ...
  int Split(const idPlane& splitPlane, idBrushSide** front,
...
class idBrush {
 ...
 public:
  ...
  int Split(const idPlane& plane, int planeNum, idBrush** front,
            idBrush** back) const;
...
class idBrushList {
 public:
  ...
  void Split(const idPlane& plane, int planeNum, idBrushList& frontList,
             idBrushList& backList, bool useBrushSavedPlaneSide = false);
