...
============
*/
idLedge::idLedge(const idVec3& v1, const idVec3& v2, const idVec3& gravityDir,
                 idBrushBSPNode* n) {
  start = v1;
  end = v2;
  node = n;
...
============
*/
bool idAASBuild::IsLedgeSide_r(idBrushBSPNode* node, idFixedWinding* w,
...
============
*/
void idAASBuild::AddLedge(const idVec3& v1, const idVec3& v2,
                          idBrushBSPNode* node) {
  int i, j, merged;
